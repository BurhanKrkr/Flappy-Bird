...
public class Game extends ApplicationAdapter {
	...
	public void create () {
		...
		ari1 = new Texture("1.png");
		ari2 = new Texture("2.png");
		ari3 = new Texture("1.png");
	...
	public void render () {
		...
		if(state==1){
			...
			font1.draw(batch,"TEKRAR DENEYINIZ!",50,Gdx.graphics.getHeight()/2);
			if(flag1){
				sound.play();
				flag1=false;
			}
			...
			flag1 = true;
			font1.draw(batch,"BASLAMAK ICIN TIKLAYINIZ!!",Gdx.graphics.getWidth()/8,Gdx.graphics.getHeight()/2);
			//sound.play();
		...
		font.draw(batch,String.valueOf(puan),Gdx.graphics.getWidth()-2*bw,2*bh);
